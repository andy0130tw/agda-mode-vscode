...
function make(path, args) {
  ...
  console.log("[XXXXXXXXXXXXXX] starting process", path, args);
  ...
  Core__Option.forEach(Caml_option.nullable_to_opt($$process.stdout), (function (stream) {
          stream.on("data", (function (chunk) {
                  console.log("[XXXXXXXXXXXXX] proc ondata", chunk);
  ...
  Core__Option.forEach(Caml_option.nullable_to_opt($$process.stderr), (function (stream) {
          stream.on("data", (function (chunk) {
                  console.log("[XXXXXXXXXXXXX] proc onerr", chunk);
                  Chan$AgdaModeVscode.emit(chan, {
                        TAG: "Stderr",
                        _0: chunk.toString()
                      });
  ...
  $$process.on("disconnect", (function () {
          ...
          console.log("[XXXXXXXXXXXXX] proc error", exn);
          Chan$AgdaModeVscode.emit(chan, {
                TAG: "Event",
                _0: {
                  TAG: "OnError",
  ...
  Promise.race([
        ...
        console.log("[XXXXXXXXXXXXX] proc exit", exitCode);
        Chan$AgdaModeVscode.emit(chan, {
              TAG: "Event",
              _0: {
                TAG: "OnExit",
